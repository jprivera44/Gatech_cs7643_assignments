...
params1 = {
    ...
    'content_image': 'styles_images/ibex.jpeg',
    'style_image': 'styles_images/royalty-free-uk.jpeg',
    'image_size': 192,
    'style_size': 512,
    'content_layer': 3,
    'content_weight': 5e-800,
    'style_layers': (1, 4, 6, 7),
...
print("Transferring content/style...")
#changing below to only do the first 1
for i in tqdm(range(len(pd)), desc="Transferring content/style...", leave=True):
#for i in tqdm(range(1), desc="Transferring content/style...", leave=True):
